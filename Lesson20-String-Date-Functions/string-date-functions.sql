...
-- 3. How Many Students where born in each month? Display the Month Name
...
-- 6. Select the characters in the position description from characters
--    8 to 12 for PositionID 5.
