...
--    Display the PaymentTypeID and the count.


-- 3. Select the average Mark for each studentID.
--    Display the StudentID and their average mark.


-- 4. Select the same data as question 3 but only show the StudentID's
--    and averages that are > 80.
