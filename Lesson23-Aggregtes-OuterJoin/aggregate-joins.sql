...
-- 3. How many payments where made for each payment type?
--    Display the PaymentTypeDescription and the count.


-- 4. Select the average Mark for each student.
--    Display the Student Name and their average mark.
