...
-- 4. Use the Student_Grades view to create a grade report for StudentID 199899200 that shows the students ID,
--    full name, course names and marks.


-- 5. Select the same information using the Student_Grades view for StudentID 199912010.


-- 6. Using the Student_Grades view, update the mark for StudentID 199899200 in course DMIT152 to be 90
