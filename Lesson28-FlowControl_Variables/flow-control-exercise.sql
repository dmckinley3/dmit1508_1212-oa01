...
more than the total of the payments that student has made then print ‘balance owing!’, otherwise print ‘Paid in full! Welcome to School 158!’
Do Not use the BalanceOwing field in your solution.
*/


/*
3. Create a stored procedure called ‘DoubleOrNothin’. It will accept a student’s first name and last
name as parameters. If the student name already is in the table then print ‘We already have a student
with the name FirstName lastName!’, otherwise print ‘Welcome Firstname lastName!’.
*/
...
if it is between 11 and 20 print ‘Exceptional effort!’, if the number is greater than 20 print
